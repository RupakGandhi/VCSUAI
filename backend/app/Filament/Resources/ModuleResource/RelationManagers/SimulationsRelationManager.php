...
class SimulationsRelationManager extends RelationManager
{
    protected static string $relationship = 'simulations';
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('prompt_text')->limit(50)->label('Trigger'),
            ])
            ->filters([
